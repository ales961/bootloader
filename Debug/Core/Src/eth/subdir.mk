...
C_SRCS += \
../Core/Src/eth/lwip_tcp.c \
../Core/Src/eth/tcp_protocol.c 

OBJS += \
./Core/Src/eth/lwip_tcp.o \
./Core/Src/eth/tcp_protocol.o 

C_DEPS += \
./Core/Src/eth/lwip_tcp.d \
./Core/Src/eth/tcp_protocol.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/eth/%.o Core/Src/eth/%.su: ../Core/Src/eth/%.c Core/Src/eth/subdir.mk
...
clean-Core-2f-Src-2f-eth:
	-$(RM) ./Core/Src/eth/lwip_tcp.d ./Core/Src/eth/lwip_tcp.o ./Core/Src/eth/lwip_tcp.su ./Core/Src/eth/tcp_protocol.d ./Core/Src/eth/tcp_protocol.o ./Core/Src/eth/tcp_protocol.su
